...
export default function CTA() {
    return (
        ...
        >
            <div className="max-w-5xl mx-auto bg-gradient-to-br from-[color:var(--accent)] to-[color:var(--pink)] rounded-3xl overflow-hidden shadow-2xl">
                <div className="relative px-8 md:px-12 py-16 md:py-24">
                    ...
                    <div className="relative text-center md:text-left md:flex md:items-center md:justify-between gap-8">
                        ...
                        <Link
                            ...
                            className="inline-block px-8 py-4 rounded-xl bg-white text-[color:var(--accent)] font-bold transition-all duration-300 hover:bg-white/90 hover:shadow-xl hover:-translate-y-1"
                        >
                            Send me an email
                        </Link>
                    </div>
